...
<head>
    ...
    <title>MyShop â€” Modern MY STYLE</title>
...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>SUMMER Collection â€” Premium Picks</h1>
                <p>Discover the latest trends in fashion, technology and accessories â€” curated just for you. Enjoy limited-time deals and free shipping on selected items.</p>
                <div>
        ...
        <section id="deals" class="section container" aria-labelledby="deals-title">
            <div class="title" id="deals-title">
                <h2>Flash Sale</h2>
                <p class="muted">Limited-time offers â€” don't miss out!</p>
            </div>
            ...
            <div class="deal" style="align-items:stretch;">
                ...
                <div class="content">
                    ...
                    <p class="muted">Thin, light and powerful â€” now with M2 performance.</p>
    ...
    <footer>
        ...
        <div style="text-align:center;margin-top:22px;color:var(--muted);font-size:13px">Â© <span id="year"></span> NexusShop. All rights reserved.</div>
    </footer>
    ...
    <script>
                ...
                el.innerHTML = `
                    ...
                    <div class="product-body">
                        ...
                        <div class="price-row">
                            ...
                            <div class="rating">${'â˜…'.repeat(Math.round(p.rating))} <span style="font-size:12px;color:var(--muted)">(${p.reviews})</span></div>
                        </div>
                    </div>
        ...
        catMenuBtn && catMenuBtn.addEventListener('click', (e) => {
            e.preventDefault();
            alert('Use the category tiles below to filter â€” this is a demo.');
        });
